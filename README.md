...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-neh71a8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-neh71a8.containers.anotherwebservice.com/
...
```
git clone git@github.com:johnkennyuk/container-neh71a8.git
cd container-neh71a8
```
...
```
docker attach container-neh71a8
```
